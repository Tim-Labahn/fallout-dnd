...
const perks: Perk[] = [
    ...
    },
    {
        name: "Barbarian",
        ranks: 1,
        requirements: { STR: 70, LVL: 4, Race: "Human" },
        description:
    ...
    },
    {
        ...
        ranks: 3,
        requirements: { END: 60, LVL: 1, Race: "Not a Robot" },
        description:
